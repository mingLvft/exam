<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpStudy\PHPTutorial\WWW\exam1\public/../application/admin\view\selection\add.html";i:1571211842;s:73:"D:\phpStudy\PHPTutorial\WWW\exam1\application\admin\view\public\base.html";i:1569555673;}*/ ?>
<!doctype html>
                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea placeholder="请输入题目" id="desc" name="selection_name" lay-verify="required" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="desc" class="layui-form-label">A选项</label>
                        <div class="layui-input-block">
                            <textarea placeholder="请输入A选项" id="desc" name="A" lay-verify="required" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="desc" class="layui-form-label">B选项</label>
                        <div class="layui-input-block">
                            <textarea placeholder="请输入B选项" id="desc" name="B" lay-verify="required" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="desc" class="layui-form-label">C选项</label>
                        <div class="layui-input-block">
                            <textarea placeholder="请输入C选项" id="desc" name="C" lay-verify="required" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="desc" class="layui-form-label">D选项</label>
                        <div class="layui-input-block">
                            <textarea placeholder="请输入D选项" id="desc" name="D" lay-verify="required" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
        ...
        <script>
            ...
            function() {
                ...
                form.on('submit(add)', function(data) {
                    $.post("<?php echo url('Selection/add'); ?>",{data:data.field},function (data) {
                        if(data.status == 1){
                            //发异步，把数据提交给php
