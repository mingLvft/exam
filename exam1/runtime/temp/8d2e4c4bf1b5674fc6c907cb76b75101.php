<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpStudy\PHPTutorial\WWW\exam1\public/../application/admin\view\selection\index.html";i:1571884395;s:73:"D:\phpStudy\PHPTutorial\WWW\exam1\application\admin\view\public\base.html";i:1569555673;}*/ ?>
<!doctype html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加','<?php echo url('Selection/add'); ?>',800,600)"><i class="layui-icon"></i>添加</button>
                            <form  class="layui-form layui-col-space5" style="display: inline-block" name="form1" action="<?php echo url('Selection/import'); ?>" enctype="multipart/form-data" href="javascript:;" method="post" id="import">
                                <div class="layui-inline layui-show-xs-block">
                            ...
                            <a href="<?php echo url('Selection/expData'); ?>">
                                <button type="button" class="layui-btn" >
                                    <i class="layui-icon">&#xe67c;</i>导出多选题
                                </button>
                            </a>
                            ...
                            <table class="layui-table layui-form" lay-size="sm">
                                ...
                                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                  <tr>
                                    ...
                                    <td class="td-manage">
                                      <a title="编辑"  onclick="xadmin.open('编辑','<?php echo url('Selection/edit'); ?>?id=<?php echo $vo['id']; ?>',600,400)" href="javascript:;">
    ...
    <script>
      layui.use(['laydate','form','upload'], function(){
        ...
        laydate.render({
          ...
          form.on('select(major)',function (data) {
              ...
              $.post("<?php echo url('Selection/major'); ?>",{major_id:major_id},function (data) {
          ...
          form.on('select(major1)',function (data) {
              ...
              $.post("<?php echo url('Selection/major1'); ?>",{major_id1:major_id1},function (data) {
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              $.post("<?php echo url('Selection/del'); ?>",{id:id},function (data) {
                  if(data.status == 1){
                      //删除成功 删除元素
      ...
      function delAll (argument) {
        ...
        //批量删除
          layer.confirm('确认要删除吗？'+ids.toString(),function(index){
              //ajax请求 id数组
            $.post("<?php echo url('Selection/del'); ?>",{id:ids},function (data) {
                if(data.status == 1){
                    //捉到所有被选中的，发异步进行删除
