<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpStudy\PHPTutorial\WWW\exam1\public/../application/admin\view\operation\add.html";i:1571211755;s:73:"D:\phpStudy\PHPTutorial\WWW\exam1\application\admin\view\public\base.html";i:1569555673;}*/ ?>
<!doctype html>
                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea placeholder="请输入题目" id="desc" name="operation_name" lay-verify="required" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
        ...
        <script>
            ...
            function() {
                ...
                form.on('submit(add)', function(data) {
                    $.post("<?php echo url('Operation/add'); ?>",{data:data.field},function (data) {
                        if(data.status == 1){
                            //发异步，把数据提交给php
