                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="right_key" lay-verify="required">
                                ...
                                <option value="1" <?php if($data['right_key'] == '1'): ?>selected<?php endif; ?>>正确</option>
                                <option value="0" <?php if($data['right_key'] == '0'): ?>selected<?php endif; ?>>错误</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
        ...
        <script>layui.use(['form', 'layer'],
            function() {
                ...
                form.on('submit(add)', function(data) {
                    $.post("<?php echo url('Judge/edit'); ?>",{data:data.field},function (data) {
                        if(data.status == 1){
                            //修改成功
                            //发异步，把数据提交给php
